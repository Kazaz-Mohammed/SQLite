...
public class EtudiantService {
    ...
    private static final String CREATE_TABLE_ETUDIANT =
            "CREATE TABLE etudiant (id INTEGER PRIMARY KEY AUTOINCREMENT, " +
    ...
    public void create(Etudiant e){
        ...
        values.put("dateNaissance", e.getDateNaissance());  // Add date
...
//    }
    ...
    public void delete(Etudiant etudiant) {
        SQLiteDatabase db = this.helper.getWritableDatabase();
        db.delete("etudiant", "id=?", new String[]{String.valueOf(etudiant.getId())});
        db.close();
    }
